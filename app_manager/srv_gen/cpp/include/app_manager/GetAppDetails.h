/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-electric-multimaster-experimental-0.1.9/debian/ros-electric-multimaster-experimental/opt/ros/electric/stacks/multimaster_experimental/app_manager/srv/GetAppDetails.srv */
...
private:
  static const char* __s_getDataType_() { return "app_manager/GetAppDetailsRequest"; }
public:
...
private:
  static const char* __s_getServerMD5Sum_() { return "982707be65dd9bb38c19f6e18cb18db5"; }
public:
...
private:
  static const char* __s_getDataType_() { return "app_manager/GetAppDetailsResponse"; }
public:
  ROS_DEPRECATED static const std::string __s_getDataType() { return __s_getDataType_(); }
...
private:
  static const char* __s_getMD5Sum_() { return "404cd76612a719d24ac22fba2d495de8"; }
public:
  ROS_DEPRECATED static const std::string __s_getMD5Sum() { return __s_getMD5Sum_(); }
...
private:
  static const char* __s_getMessageDefinition_() { return "ExchangeApp app\n\
\n\
\n\
\n\
================================================================================\n\
...
public:
  ...
  {
    ros::serialization::OStream stream(write_ptr, 1000000000);
    ros::serialization::serialize(stream, app);
    return stream.getData();
  }
  ...
  {
    ros::serialization::IStream stream(read_ptr, 1000000000);
    ros::serialization::deserialize(stream, app);
    return stream.getData();
  }
  ...
  {
    uint32_t size = 0;
    size += ros::serialization::serializationLength(app);
    return size;
  }
