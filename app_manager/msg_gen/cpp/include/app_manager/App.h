/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-electric-multimaster-experimental-0.1.9/debian/ros-electric-multimaster-experimental/opt/ros/electric/stacks/multimaster_experimental/app_manager/msg/App.msg */
...
struct App_ {
  ...
  ROS_DEPRECATED uint32_t get_client_apps_size() const { return (uint32_t)client_apps.size(); }
  ROS_DEPRECATED void set_client_apps_size(uint32_t size) { client_apps.resize((size_t)size); }
  ROS_DEPRECATED void get_client_apps_vec(std::vector< ::app_manager::ClientApp_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::app_manager::ClientApp_<ContainerAllocator> >::other > & vec) const { vec = this->client_apps; }
  ROS_DEPRECATED void set_client_apps_vec(const std::vector< ::app_manager::ClientApp_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::app_manager::ClientApp_<ContainerAllocator> >::other > & vec) { this->client_apps = vec; }
private:
  static const char* __s_getDataType_() { return "app_manager/App"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "643c1db5f71b615a47789ff5e190811e"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, client_apps);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, client_apps);
    return stream.getData();
  }
  ...
  ROS_DEPRECATED virtual uint32_t serializationLength() const
  {
    ...
    size += ros::serialization::serializationLength(client_apps);
    return size;
  }
